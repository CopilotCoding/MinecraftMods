...
public enum MicrobeEffect {
    ...
    NAUSEA("Nausea",                    MobEffects.NAUSEA,           EffectCategory.NEGATIVE),
    SLOWNESS("Lethargy",                MobEffects.SLOWNESS,   EffectCategory.NEGATIVE),
    ...
    MINING_FATIGUE("Neural Degradation",MobEffects.MINING_FATIGUE,        EffectCategory.NEGATIVE),
    ...
    SPEED("Metabolic Stimulant",          MobEffects.SPEED,      EffectCategory.POSITIVE),
    RESISTANCE("Immune Fortification",    MobEffects.RESISTANCE,   EffectCategory.POSITIVE),
    ...
    JUMP_BOOST("Neuromuscular Enhancement",MobEffects.JUMP_BOOST,              EffectCategory.POSITIVE),
    HASTE("Adrenal Symbiosis",            MobEffects.HASTE,           EffectCategory.POSITIVE),
