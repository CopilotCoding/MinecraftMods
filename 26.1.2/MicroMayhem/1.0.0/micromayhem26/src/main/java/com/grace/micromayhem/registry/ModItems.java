...
public class ModItems {
    ...
    public static final DeferredItem<HazmatArmorItem> HAZMAT_HELMET =
        ITEMS.registerItem("hazmat_helmet", p -> new HazmatArmorItem(ArmorType.HELMET, p), p -> p.durability(240));
    public static final DeferredItem<HazmatArmorItem> HAZMAT_CHESTPLATE =
        ITEMS.registerItem("hazmat_chestplate", p -> new HazmatArmorItem(ArmorType.CHESTPLATE, p), p -> p.durability(320));
    public static final DeferredItem<HazmatArmorItem> HAZMAT_LEGGINGS =
        ITEMS.registerItem("hazmat_leggings", p -> new HazmatArmorItem(ArmorType.LEGGINGS, p), p -> p.durability(300));
    public static final DeferredItem<HazmatArmorItem> HAZMAT_BOOTS =
        ITEMS.registerItem("hazmat_boots", p -> new HazmatArmorItem(ArmorType.BOOTS, p), p -> p.durability(260));
