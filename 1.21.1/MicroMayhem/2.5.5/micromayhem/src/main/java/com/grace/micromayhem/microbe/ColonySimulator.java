...
public class ColonySimulator {
    ...
    private static void tickSystem(
        ...
        // Clean up cleared strains and grant natural immunity
        for (long id : toRemove) {
            colony.removeStrain(id);
            // Natural clearance grants immunity and strengthens immune ceiling
            immune.onNaturalClearance(id, java.time.Instant.now().getEpochSecond());
