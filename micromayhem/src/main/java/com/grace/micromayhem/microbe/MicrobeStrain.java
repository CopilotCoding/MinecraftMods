...
public class MicrobeStrain {
    ...
    public CompoundTag save() {
        ...
        tag.putString("AutoimmunePotential", autoimmunePotential.name());
        tag.putString("LethalityProfile", lethalityProfile.name());
        tag.putString("PrimarySystem", primarySystem.name());
        tag.putString("BiomePreference", biomePreference.name());
